...
public class DVControlPayload {
	...
	static final int MAX_PAYLOAD_SIZE = 804; // 4 + 100 * 2X4 bytes = 804 bytes
	private ByteBuffer bb;
	
	/**
	* Constructor for creating a new DVControlPayload containing a distances vector
	* 
	...
	**/
	public DVControlPayload (int tot, int[] announcements) {
			bb = ByteBuffer.allocate(MAX_PAYLOAD_SIZE);
			bb.putInt(tot);
			int i = 0;
			while ( i < tot*2 ) {
